 ...
 * @public
 */
export declare type JSONSchemaTypeName = 'array' | 'boolean' | 'integer' | 'null' | 'number' | 'object' | 'string';
/**
 * JSON Schema type.
 *
 * @public
 ...
 * @public
 */
export declare type JSONSchemaTypeValue = JSONSchemaTypeName | JSONSchemaType | (JSONSchemaType | JSONSchemaTypeName)[];
/**
 * Content encoding name.
 *
 * @public
 */
export declare type JSONSchemaContentEncodingName = '7bit' | '8bit' | 'binary' | 'quoted-printable' | 'base64' | 'ietf-token' | 'x-token';
/**
